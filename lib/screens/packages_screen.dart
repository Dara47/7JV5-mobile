      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          children: [
            ...
            Row(children: [
              ...
              Text(
                ...
                style: const TextStyle(color: Color(0xFFEA580C), fontWeight: FontWeight.w600, fontSize: 13)),
            ]),
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Row(children: [
                  const Icon(Icons.calendar_today, size: 14, color: Color(0xFFEA580C)),
                  const SizedBox(width: 6),
                  Text(pkg.scheduleLabel, style: const TextStyle(fontSize: 13, color: Color(0xFFEA580C), fontWeight: FontWeight.w600)),
                  const Spacer(),
                  const Icon(Icons.edit_calendar, size: 14, color: Color(0xFFEA580C)),
                  const SizedBox(width: 4),
                  const Text('ย้าย', style: TextStyle(fontSize: 11, color: Color(0xFFEA580C))),
                ]),
              ),
            ),
        ...
        Container(
          ...
          child: Row(children: [
            ...
            _vDivider(),
            _ActionBtn(icon: Icons.edit_outlined, label: 'Edit', color: const Color(0xFFEA580C), onTap: onEdit),
            _vDivider(),
    ...
    child: Container(
      ...
      child: Column(children: [
        ...
        Text(
          ...
          style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFFEA580C)),
        ),
      ]),
    ),
  );
                ...
                return Card(
                  ...
                  child: ListTile(
                    leading: CircleAvatar(
                      radius: 18,
                      backgroundColor: const Color(0xFFEA580C).withAlpha(20),
                      child: Text('${i + 1}', style: const TextStyle(fontSize: 12, color: Color(0xFFEA580C), fontWeight: FontWeight.bold)),
                    ),
