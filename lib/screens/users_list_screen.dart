      ...
      builder: (context, snap) {
        ...
        return ListView.separated(
          ...
          itemBuilder: (context, i) {
            final u = filtered[i];
            final color = role == 'student' ? const Color(0xFFEA580C) : const Color(0xFF2E7D32);
            return Card(
                      ...
                      return Padding(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          Wrap(spacing: 6, crossAxisAlignment: WrapCrossAlignment.center, children: [
                            ...
                            Text('$total คาบ', style: const TextStyle(fontSize: 12, color: Color(0xFFEA580C), fontWeight: FontWeight.w600)),
                            if (hasAdj) ...[
                              if (u.totalAdded > 0)
                                Container(
