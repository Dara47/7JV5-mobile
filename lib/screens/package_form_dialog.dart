    ...
    return Container(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Padding(
          ...
          child: Row(children: [
            Icon(_isEdit ? Icons.edit_outlined : Icons.add_circle_outline, color: const Color(0xFF1565C0)),
                      ...
                      Wrap(
                        ...
                        children: PackageModel.days.map((d) => GestureDetector(
                          ...
                          child: AnimatedContainer(
                            ...
                            width: 44, height: 44,
                            decoration: BoxDecoration(
                              color: _scheduledDay == d ? const Color(0xFF1565C0) : Colors.grey.shade100,
                              shape: BoxShape.circle,
                              border: Border.all(color: _scheduledDay == d ? const Color(0xFF1565C0) : Colors.grey.shade300),
                            ),
  ...
  Widget build(BuildContext context) => GestureDetector(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(10),
        border: Border.all(color: time != null ? const Color(0xFF1565C0).withAlpha(100) : Colors.grey.shade300),
      ),
      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Text(label, style: const TextStyle(fontSize: 10, color: Colors.grey)),
        Text(
          time != null ? '${time!.hour.toString().padLeft(2,'0')}:${time!.minute.toString().padLeft(2,'0')}' : 'แตะเพื่อเลือก',
          style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: time != null ? const Color(0xFF1565C0) : Colors.grey),
        ),
      ]),
    ),
  );
